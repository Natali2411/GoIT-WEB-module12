...
from src.schemas import ContactChannelResponse, ContactResponse, ContactModel, \
    ChannelModel
...
async def update_channel(channel_id: int, body: ChannelModel, db: Session) -> (Channel |
                                                                               None):
